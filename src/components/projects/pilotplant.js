        ...
        <div className="projectBlock">
            <div className="projectsObjBlock">
                ...
                <div className="projectsDesc">
                    ...
                    <p className="projectPara">web application built for operators to monitor and control elektrofis pilot scale manufacturing system. built using flask where a python backend passes data between a plc control system and a javascript frontend. frontend allows for easy monitoring and controls allowing operators to quickly use the equipment without having to learn the complex plc ladder logic.</p>
