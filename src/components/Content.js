            ...
            <section className="about">
                <h2>about.</h2>
                    <div className="aboutText">
                        <p>hey! my name’s moin and i’m a <span style={{color:'#11CE8A'}}>chemical engineer</span> looking to expand my work experience in biotech and software development. i studied chemical engineering at <a href="https://northeastern.edu/" target="_blank"><span style={{color:'#D95D6A'}}>northeastern university</span></a> and spent two six-month co-ops working on <span style={{color:'#537AD9'}}>small molecule synthesis</span> and <span style={{color:'#5B2392'}}>continuous flow chemistry</span>.</p>
                        ...
                        <p>in my free time, i study <span style={{color:'#F57A67'}}>web development</span> as a creative outlet, getting to combine my love of building something thats both visually pleasing and functional.</p>
                    ...
                    <div className="aboutSide">
                        ...
                        <div className="aboutScroll" id="scroll">
                            <h2>engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 | engineer | chemist | musician | biker | skier | اُردُو | aquarist | traveler | barista | 日本語 </h2>
                        </div>
                    </div>  
            </section>
